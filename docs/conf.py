...
# -*- coding: utf-8 -*-
#
# pyC8 documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pyC8.tex', 'pyC8 Documentation',
     'Macrometa', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyC8', 'pyC8 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyC8', 'pyC8 Documentation',
     author, 'pyC8', 'One line description of project.',
     'Miscellaneous'),
]

...
def create_subscriber():
    ...
    for i in range(10):
        ...
        print(
            "Received: Msg_Body:'{}' Msg_ID:'{}'".format(msg.data(), msg.message_id())
        )
...
if __name__ == "__main__":
    ...
    fabric.create_stream(
        stream_name, local=True
    )  # set local=False for geo-replicated stream available in all regions.

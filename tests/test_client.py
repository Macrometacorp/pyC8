...
def test_client_attributes():
    ...
    assert client.base_url == 'https://api-{}:443'.format(os.environ.get('FEDERATION_URL'))
    ...
    assert repr(client) == '<C8Client https://api-{}:443>'.format(os.environ.get('FEDERATION_URL'))
